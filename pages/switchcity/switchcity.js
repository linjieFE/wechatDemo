...
Page({
  ...
  getLocation: function () {
    ...
    wx.getLocation({
      ...
      success: function (res) {
        ...
        wx.request({
          url: `${app.globalData.apiMap}/ws/geocoder/v1/?location=${latitude},${longitude}&key=${app.globalData.tencentMapKey}`,
          success: res => {
            that.setData({
  ...
  selectCounty: function () {
    ...
    const that = this;
    wx.request({
      url: `${app.globalData.apiMap}/ws/district/v1/getchildren?&id=${code}&key=${app.globalData.tencentMapKey}`,
      success: function (res) {
        that.setData({
